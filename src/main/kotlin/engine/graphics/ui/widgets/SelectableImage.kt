 ...
 */
fun GUI.selectableImage(texture: TextureRegion, width: Float = style.elementSize, height: Float = style.elementSize, isSelected: Boolean, element: GUIElement = getLastElement(), action: () -> Unit): GUIElement {
    val (x, y) = element
